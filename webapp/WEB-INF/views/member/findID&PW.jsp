...
<div class="container">
	...
	<div class="row">
		<div class="main_body" style="width: 100%;">
			<div id="left_menu"
				style="float: left; width: 130px; padding-top: 7px; margin-left: 40px;">
				<!-- -20px -->
				<div id="l_first_title"
					...
					<ul id="title_list"
						style="list-style: none; padding-left: 10px; text-decoration: none; padding-top: 5px;">
						<li><a href="/NeedLogin">로그인</a></li>
						<li><a href="/Member/">회원가입</a></li>
						<li><a id="current" href="/Member/findID&PW">아이디/ <br />
								<span style="margin-left: 20px;">비밀번호 찾기</span></a></li>
					</ul>
				</div>
			</div>
			<br>
					...
					<tr style="vertical-align: center; padding-left: 10px">
							...
							<div id="block" class="left-box"
								...
								<table id="tableID"
									...
									<tbody>
										<tr>
											<td><span>이름</span></td>
											<td><input type="text" id="korname"
												style="border: none; border-bottom: 2px solid red; width: 230px;">
											</td>
										</tr>
										<tr>
											<td><span>이메일 주소</span></td>
											<td><input type="text" id="emailID"
						...
						<td style="width: 50%; padding-left: 10px">
							<div style="margin-left: 2cm;">
								<div id="top_row"
									style="width: 100%; padding-top: 5px; font-weight: bold;">
