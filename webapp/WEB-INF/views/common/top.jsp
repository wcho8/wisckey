                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class=" down">
                            ...
                            <ul class="dropdown-menu">
                                <li >
                                    <a href="/About/introWisckey" >위스키 소개</a>
                                </li>
                                <li >
                                    <a href="/About/introUniv" >학교 소개</a>
                                </li>
                                <li >
                                    <a href="/About/" >공지사항</a>
                                </li>
                                <li >
                                    <a href="/About/otherSites" >주요사이트 소개</a>
                                </li>
                            </ul>
                        </li>
                        
                        <li class=" down">
                            <a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> 취업 <span class="caret"></span></a>
                            <ul class="dropdown-menu">
                                <li >
                                    <a href="/Career/" >취업공고</a>
                                </li>
                                <li >
                                    <a href="/Career/employBoard" >취업 게시판</a>
                                </li>
                        ...
                        <li class=" down">
                            <a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> 학업 <span class="caret"></span></a>
                            <ul class="dropdown-menu">
                                <li >
                                    <a href="/School/pastWork" >족보</a>
                                </li>
                                <li >
                                    <a href="/School/education" >학업 게시판</a>
                                </li>
                         ...
                         <li class=" down">
                            <a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> 깨알팁 <span class="caret"></span></a>
                            <ul class="dropdown-menu">
                                <li >
                         ...
                         <li class=" down">
                            <a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> 동아리 게시판 <span class="caret"></span></a>
                            <ul class="dropdown-menu">
                                <li >
                                    <a href="#" >동아리 정보</a>
                                </li>
                        ...
                        <li class=" down">
                            <a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> 자유게시판 <span class="caret"></span></a>
                            <ul class="dropdown-menu">
                                <li >
                                    <a href="/Board/" >게시판</a>
                                </li>
                        ...
                        <li class=" down" style="display:none;" id="admin_menu">
                            <a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> 관리자 <span class="caret"></span></a>
                            <ul class="dropdown-menu">
                                <li >
                                    <a href="#" >ABOUT관리</a>
                                </li>
                                ...
                                <li >
                                    <a href="/Admin/ManageOrg" >동아리 관리</a>
                                </li>
